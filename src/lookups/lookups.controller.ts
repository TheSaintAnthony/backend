...
export class LookupsController {
  ...
  @Get('menucategories')
  getMenuCategories() {
    return this.lookupsService.getMenuCategories();
  }
  @Public()
  @Get('menucategories/:id')
  getMenuCategoryById(@Param('id') id: string) {
    return this.lookupsService.getMenuCategoryById(id);
  }
  ...
  deleteMenuCategory(@Param('id') id: string) {
    return this.lookupsService.deleteMenuCategory(id);
  }
}
